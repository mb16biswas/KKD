...
batch_size = args.b 
n_layer = 6 
dir_ = "/workspace/legal/downstream/scotus"
...
train_dataset = load_dataset("lex_glue", "scotus", split="train")
eval_dataset = load_dataset("lex_glue", "scotus", split="validation")
